...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InfinispanServerConfiguration) DeepCopyInto(out *InfinispanServerConfiguration) {
	*out = *in
	if in.CmdArgs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InfinispanServerConfiguration.
func (in *InfinispanServerConfiguration) DeepCopy() *InfinispanServerConfiguration {
	if in == nil {
		return nil
	}
	out := new(InfinispanServerConfiguration)
	in.DeepCopyInto(out)
	return out
}
